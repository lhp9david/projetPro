    ...
    <div class="container">
        ...
        <form action="" method="POST" class="col-lg-6 mx-auto">
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="confirmMail" class="form-label fw-bold">Confirmer votre email</label>
                <input type="email" class="form-control" id="confirmMail"  name="confirMmail">
              </div>
            <div class="mb-3">
              <label for="password" class="form-label fw-bold">Veuillez choisir un mot de passe</label>
              <input type="password" class="form-control" id="password" name="password">
            </div>
            <div class="mb-3">
                <label for="confirmPass" class="form-label fw-bold">Confirmer le mot de passe</label>
                <input type="password" class="form-control" id="confirmPass" name="confirmPass">
              </div>
            <div class="mb-3 form-check">
              <input type="checkbox" class="form-check-input" id="CGU" name="CGU">
              <label class="form-check-label fw-bold" for="CGU">Veuillez accepter les CGU</label>
            </div>
