  ...
  <div class="container">
    ...
    <form action="" method="POST" class="col-lg-6 mx-auto">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="firstname" name="firstname" value="<?= (isset($_POST['firstname'])) ? $_POST['firstname'] : ''; ?>"><span class="text-danger"><?= isset($errors['firstname']) ? $errors['firstname'] : '' ?></span>
      </div>
      <div class="mb-3">
        <label for="lastname" class="form-label fw-bold fs-5">Nom</label>
        <input type="text" class="form-control" id="lastname" name="lastname" value="<?= (isset($_POST['lastname'])) ? $_POST['lastname'] : '';?>"><span class="text-danger"><?= isset($errors['lastname']) ? $errors['lastname'] : '' ?></span>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="password" class="form-control" id="confirmPass" name="confirmPass"><span class="text-danger"><?= isset($errors['confirmPass']) ? $errors['confirmPass'] : '' ?><?= isset($errors['error']) ? $errors['error'] : '' ?></span>
      </div>
      <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input" id="CGU" name="CGU">
        <label class="form-check-label fw-bold fs-5" for="CGU">Veuillez accepter les CGU</label> <br> <span class="text-danger"><?= isset($errors['CGU']) ? $errors['CGU'] : '' ?></span>
      </div>
