...
<nav class="navbar navbar-expand-lg bg-gold shadow">
  <div class="container-fluid">
    <a class="navbar-brand" href="../controllers/controller-accueil.php?month=<?=date('m')?>&year=<?=date('Y')?>"><img src="/assets/img/calendar.png" alt="logo"></a>
    ...
    <div class="collapse navbar-collapse lien" id="navbarNavAltMarkup">
      ...
      <div><a class="nav-link deco" href="../controllers/controller-login.php?logout">Deconnexion</a></div>
    </div>
  </div>
</nav>
